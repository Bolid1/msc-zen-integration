...
* Требуется поддерживать большее количество кода, чем при прямой пересылке данных из одного сервиса в другой

## Сверки

Сверки необходимы для того, чтобы быть уверенными, что 
